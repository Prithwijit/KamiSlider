...
$(function () {
	...
	$('#sliderManualRotationMulti').on('input change', function () {
		$("label[for='sliderManualRotationMulti']").text("Rotate camera for: " + parseInt(this.value) + "°");
	});
	...
	$('#sliderManualPositionMulti').on('input change', function () {
		ui_update_slider_labelMulti();
	});
	...
	$('#sliderManualPositionMulti').bind('mousewheel', function (event) {
		mousewheel_slideMulti(event);
	});
	...
	$('#btnManualMoveL').on('click', function () {
		var posSlide = parseInt($("#sliderManualPosition").val());
		var cfgSliderSpeed = $("#cfgSliderSpeed").val();
		var cfgSliderAccel = $("#cfgSliderAccel").val();
		...
		var cfgRotationSpeed = $("#cfgRotationSpeed").val();
		var cfgRotationAccel = $("#cfgRotationAccel").val();
		var scrollWheelValue = parseInt($("#scrollWheelNumber").text());
		...
		// Update the position of the slider by subtracting the scrollWheelValue
		var newPosSlide = posSlide - scrollWheelValue;
		// Make sure the value is within the min/max bounds of the slider
		newPosSlide = Math.max(0, newPosSlide);

		// Set the updated position to the slider
		$("#sliderManualPosition").val(newPosSlide);
		// Update the label with the new slider value
		$("#sliderManualPosition").closest('fieldset').find('label').text("Position: " + newPosSlide + "mm");
		moveToPosition(newPosSlide, cfgSliderSpeed, cfgSliderAccel, posRotate, cfgRotationSpeed, cfgRotationAccel)
	});

	$('#btnManualMoveR').on('click', function () {
		var posSlide = parseInt($("#sliderManualPosition").val());
		var cfgSliderSpeed = $("#cfgSliderSpeed").val();
		var cfgSliderAccel = $("#cfgSliderAccel").val();
		...
		console.log("cfgRotationSpeed: " + cfgRotationSpeed);
		console.log("cfgRotationAccel: " + cfgRotationAccel);
		// Update the position of the slider by adding the scrollWheelValue
		var newPosSlide = posSlide + scrollWheelValue;
		// Set the updated position to the slider
		$("#sliderManualPosition").val(newPosSlide);
		...
		// Update the label with the new slider value
		$("#sliderManualPosition").closest('fieldset').find('label').text("Position: " + newPosSlide + "mm");
		// Call the moveToPosition function with the updated position
		moveToPosition(newPosSlide, cfgSliderSpeed, cfgSliderAccel, posRotate, cfgRotationSpeed, cfgRotationAccel)
	});

	$('#btnManualMoveLMulti').on('click', function () {
		var posSlide = parseInt($("#sliderManualPositionMulti").val());
		var cfgSliderSpeed = $("#cfgSliderSpeed").val();
		var cfgSliderAccel = $("#cfgSliderAccel").val();
		...
		var cfgRotationSpeed = $("#cfgRotationSpeed").val();
		var cfgRotationAccel = $("#cfgRotationAccel").val();
		var scrollWheelValue = parseInt($("#scrollWheelNumberMulti").text());
		...
		// Set the updated position to the slider
		$("#sliderManualPositionMulti").val(newPosSlide);
		// Update the label with the new slider value
		$("#sliderManualPositionMulti").siblings('label').text("Position: " + newPosSlide + "mm");

		moveToPosition(newPosSlide, cfgSliderSpeed, cfgSliderAccel, posRotate, cfgRotationSpeed, cfgRotationAccel)
	});

	$('#btnManualMoveRMullti').on('click', function () {
		var posSlide = parseInt($("#sliderManualPositionMulti").val());
		var cfgSliderSpeed = $("#cfgSliderSpeed").val();
		var cfgSliderAccel = $("#cfgSliderAccel").val();
	...
	$('#btn_SaveSettings').on('click', function () {
		...
		var exact_time = $("#exact_time").is(":checked")
		...
		update_settings('set_exact_time', exact_time);
	});
...
function mousewheel_slideMulti(event) {
	event.preventDefault();
	console.log(event.originalEvent);

	current_value = parseInt($('#sliderManualPositionMulti').val());
	slider_step = 10;
	...
	$('#sliderManualPositionMulti').prop('value', new_value);
	ui_update_slider_labelMulti();
}
...
function ui_update_slider_labelMulti() {
	$("label[for='labelManualPositionMulti']").text("Position: " + parseInt($('#sliderManualPositionMulti').val()) + "mm");
}
...
var update_settings_urls = {
	...
	'set_exact_time': '/api/set-exact-time',
